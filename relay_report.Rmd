...
h1 { 
  color: #2c3e50;
  border-bottom: 3px solid #7e61cc;
  padding-bottom: 15px;
  margin-bottom: 30px;
  font-size: 2.5em;
  font-weight: 600;
...
h2 {
  ...
  font-size: 1.8em;
  font-weight: 600;
  border-bottom: 2px solid #7e61cc;
  padding-bottom: 8px;
}
...
/* Improved blockquote styling for callouts */
blockquote {
  border-left: 4px solid #7e61cc;
  padding-left: 20px;
  margin: 25px 0;
  font-style: italic;
  color: #5a6c7d;
...
/* Table of contents styling if enabled */
#TOC {
  background-color: #f8f9fa;
...
# Add a title
div(
  h2("📊 Jan 1 - June 30 2025 Averages within Cluster", 
...
1. Base → Abstract (4.37%, avg $48.68)
2. Solana → Base (3.80%, avg $132.89) 
3. Zora → Base (3.24%, avg $7.32)
...
# Display with titles
div(
  h2("📊 First Usage Route Pairs", 
     style = "color: #34495e; border-bottom: 2px solid #3498db; padding-bottom: 8px; margin-bottom: 15px; font-size: 18px;"),
  p("Top source → destination chain pairs for users' first Relay transaction", 
    style = "color: #7f8c8d; font-style: italic; margin-bottom: 20px;"),
  route_pairs_table,
  
  br(), br(),
  
  h2("📊 First Usage Destination Chains", 
     style = "color: #34495e; border-bottom: 2px solid #3498db; padding-bottom: 8px; margin-bottom: 15px; font-size: 18px;"),
...
# Add a title
div(
  h2("📊 Persona × Loyalty Characteristics (Marginal Effects)", 
     style = "color: #34495e; border-bottom: 2px solid #3498db; padding-bottom: 8px; margin-bottom: 15px; font-size: 18px;"),
  loyalty_table
)
